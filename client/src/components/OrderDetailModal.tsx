            ...
            {order.요청사항 && (
              <Card className="border-green-200">
                <CardContent className="pt-4">
                  ...
                  <p className="text-gray-700 bg-green-50 p-3 rounded-md border border-green-100">
                    {order.요청사항}
                  </p>
                </CardContent>
              </Card>
            ...
            {order.특이사항 && (
              <Card className="border-orange-200">
                <CardContent className="pt-4">
                  ...
                  <p className="text-gray-700 bg-orange-50 p-3 rounded-md border border-orange-100">
                    {order.특이사항}
                  </p>
                </CardContent>
              </Card>
